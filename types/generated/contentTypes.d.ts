...
export interface ApiCampaignCampaign extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    campaign_description: Schema.Attribute.Text;
    campaign_image: Schema.Attribute.Media<
...
export interface ApiCourierCourier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vehicle_plate: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiPaymentMethodPaymentMethod
  ...
  attributes: {
    ...
    expiry_month: Schema.Attribute.Integer & Schema.Attribute.Required;
    expiry_year: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
